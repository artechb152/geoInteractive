...
- ✅ **mdo** — `#scene-mdo` — ריווח אחיד 48px (היה 24px). הוסרו רקע TopoField ואייקוני תחומים דקורטיביים (הוחלפו בתוויות) וצבעי סטטוס צהוב/אדום. כפתורי הבקרה מעל התרשים ברובד טקסט אחיד. תרשים השדה והקואורדינטות שלו לא נגעו.
