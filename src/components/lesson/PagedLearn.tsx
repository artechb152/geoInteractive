  ...
  return (
    ...
    <div className="relative scroll-mt-28 xl:ps-[180px]" ref={rootRef}>
      ...
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          {/* SceneStepContext — כדי שה-chip "סצנה X מתוך Y" ב-SceneHeader
              המשותף ימשיך לעבוד גם בפריסה המשוחזרת */}
...
function ScenePagerDesktop({
  ...
  return (
    <aside
      className="hidden xl:flex flex-col fixed start-0 top-[var(--header-h)] bottom-0 z-20 w-[160px] overflow-y-auto bg-bg-elevated border-e border-border"
