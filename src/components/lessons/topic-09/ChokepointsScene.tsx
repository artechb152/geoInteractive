        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <div className="surface p-3 rounded-lg">
              <div className="text-[10px] font-mono text-fg-dim mb-0.5 tracking-widest uppercase">רוחב גיאוגרפי</div>
              <div className="text-sm text-fg font-medium">{meta.width}</div>
            </div>
            <div className="surface p-3 rounded-lg">
              <div className="text-[10px] font-mono text-fg-dim mb-0.5 tracking-widest uppercase">עומק / שוקע</div>
          ...
          <div className="space-y-3">
            <div>
              <div className={cn('text-[10px] font-mono mb-1 tracking-widest uppercase', meta.color)}>מה עובר דרך</div>
              <p className="text-sm text-fg leading-relaxed">{meta.whatPasses}</p>
            </div>
            <div>
              <div className="text-[10px] font-mono text-status-warn mb-1 tracking-widest uppercase">איומים</div>
              <p className="text-sm text-fg-muted leading-relaxed">{meta.threats}</p>
            </div>
            <div className="pt-3 border-t border-border-subtle">
              <div className="text-[10px] font-mono text-fg-dim mb-1 tracking-widest uppercase">אירועים אחרונים</div>
