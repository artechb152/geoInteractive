...
const ENERGY_SOURCES: EnergySource[] = [
  ...
  },
  {
    ...
    strategic: 'התלות כאן קשיחה: צינור קבוע קושר ספק לצרכן, והחלפתו דורשת שנות בנייה של תשתית חדשה. מי ששולט בברז שולט בחשמל, בתעשייה ובהחלטות של הצד השני – כפי שרוסיה הוכיחה מול אירופה.',
    color: 'text-accent',
    bg: 'bg-accent/10',
