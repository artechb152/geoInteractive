      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <div className={cn('text-[10px] font-mono mb-1.5 tracking-widest uppercase', meta.color)}>
                העיקרון של מהן
              </div>
              <p className="text-sm text-fg leading-relaxed">{meta.desc}</p>
            </div>
            <div>
              <div className="text-[10px] font-mono text-accent mb-1.5 tracking-widest uppercase">היישום המודרני</div>
