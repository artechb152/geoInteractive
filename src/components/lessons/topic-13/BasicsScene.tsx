      ...
      <div className="surface-elevated p-4 rounded-2xl mb-6">
        ...
        <div className="mt-4 grid sm:grid-cols-2 gap-3">
          <div className={cn('surface p-4 rounded-xl', model === 'raster' ? 'border-accent shadow-glow' : 'opacity-60')}>
            <div className="text-[10px] font-mono text-accent mb-1 tracking-widest uppercase">ראסטר</div>
          ...
          <div className={cn('surface p-4 rounded-xl', model === 'vector' ? 'border-accent shadow-glow' : 'opacity-60')}>
            <div className="text-[10px] font-mono text-accent mb-1 tracking-widest uppercase">וקטור</div>
          ...
          <div className="flex-1">
            ...
            <div className="grid sm:grid-cols-2 gap-3 mt-3">
              <div className="surface p-3 rounded-lg">
                <div className="text-[10px] font-mono text-fg-dim mb-1 tracking-widest uppercase">לוקלי</div>
              ...
              <div className="surface p-3 rounded-lg">
                <div className="text-[10px] font-mono text-accent mb-1 tracking-widest uppercase">רשתי</div>
      ...
      <svg viewBox="0 0 100 56" className="w-full h-full">
        ...
        {model === 'raster' ? (
          <g>
            ...
            <text x="50" y="6" textAnchor="middle" className="fill-fg-dim font-mono" fontSize="2.6" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.85" strokeLinejoin="round">
              ראסטר · 280 פיקסלים — כל אחד עם ערך
            </text>
            <text x="14" y="36" textAnchor="middle" className="fill-fg-dim font-mono" fontSize="1.8">
              "מבנה"
            </text>
            <text x="50" y="48" textAnchor="middle" className="fill-fg-dim font-mono" fontSize="1.8">
              "כביש"
            </text>
          </g>
        ) : (
          <g>
            ...
            <g transform="translate(8 8)">
              ...
              <text x="2" y="3" className="fill-fg-dim font-mono" fontSize="2">id | type | width</text>
              <text x="2" y="6" className="fill-fg font-mono" fontSize="2">1  | road | 8m</text>
              <text x="2" y="8.5" className="fill-fg-muted font-mono" fontSize="1.7">↑ טבלת תכונות</text>
            </g>

            <text x="50" y="54" textAnchor="middle" className="fill-fg-muted font-mono" fontSize="2.4" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.8" strokeLinejoin="round">
              וקטור · 4 אובייקטים — קווים, פוליגון, נקודה
            </text>

            {/* Labels */}
            <text x="50" y="29" textAnchor="middle" className="fill-accent-cool font-mono font-bold" fontSize="2.2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.75" strokeLinejoin="round">
              מבנה
            </text>
            <text x="72" y="22" textAnchor="middle" className="fill-status-danger font-mono font-bold" fontSize="2.2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.75" strokeLinejoin="round">
              איום
            </text>
            <text x="92" y="40" textAnchor="middle" className="fill-accent font-mono font-bold" fontSize="2.2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.75" strokeLinejoin="round">
              כביש
            </text>
          </g>
        )}
