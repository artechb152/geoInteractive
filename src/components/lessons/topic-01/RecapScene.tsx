  ...
  return (
    ...
    >
      <a
        ...
        onClick={(e) => {
          e.preventDefault();
          // Scroll to top of page (tab switch handled by shell)
          window.scrollTo({ top: 0, behavior: 'smooth' });
          // After short delay, click the practice tab
          setTimeout(() => {
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="text-xs font-mono text-fg-dim mb-0.5 tracking-widest uppercase">השלב הבא</div>
          <div className="font-display font-bold leading-tight">תרגול אינטראקטיבי</div>
          <div className="text-xs text-fg-muted mt-0.5">תרגל את מה שלמדת</div>
        </div>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="text-xs font-mono text-fg-dim mb-0.5 tracking-widest uppercase">או</div>
