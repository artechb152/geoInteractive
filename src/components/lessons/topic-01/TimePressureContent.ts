 ...
 *
 * כל מחרוזת עברית כאן הועתקה מילה במילה מ־
 ...
 * אין לערוך כאן ניסוח, פיסוק או טיפוגרפיה — התיקון נעשה בחבילת המסירה ומועתק חזרה.
 *
...
export const ROUNDS: RoundContent[] = [
  ...
  },
  {
    ...
    event: 'ההוצאות גדלות, והמילואים נשארים מגויסים.',
...
export const NODE_DEFINITIONS: Record<MapNodeId, string> = {
  ...
  public: 'התמיכה הציבורית והאופן שבו הציבור מעריך את המחיר ואת התוצאות.',
  politics: 'החלטות הדרג המדיני והוויכוח הפנימי על מטרות המערכה והמשכה.',
  international: 'יחסים עם גורמים חיצוניים והשפעת עמדותיהם על חופש הפעולה.',
};
...
export const IRREGULAR = {
  ...
  body: 'הישרדות ושימור יכולת עשויים לשרת את יעדיו.',
