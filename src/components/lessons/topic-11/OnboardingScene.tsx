      ...
      >
        ...
        <div className="relative flex-1">
          ...
          <p className="text-fg leading-relaxed text-pretty text-sm sm:text-base">
            הבנת שצורת מדינה זה לא נושא לתשבץ — זה גורל אסטרטגי. בשלוש הסצנות הבאות נצלול:
            <strong className="text-fg"> איך עומק אסטרטגי משנה דוקטרינה, איך עובד אזור חיץ, ולמה גבול טבעי שונה מגבול מלאכותי</strong>.
          </p>
        </div>
      </motion.div>
    </section>
