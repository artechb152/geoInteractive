        ...
        {LAYERS.filter((l) => activeLayers.has(l.id)).map((l) => (
          ...
          >
            ...
            <div className="space-y-2 text-xs">
              <div>
                <div className="text-[10px] font-mono text-fg-dim mb-0.5 tracking-widest uppercase">יכולת</div>
                <div className="text-fg leading-relaxed">{l.capability}</div>
              </div>
              <div>
                <div className="text-[10px] font-mono text-fg-dim mb-0.5 tracking-widest uppercase">עלות</div>
                <div className="text-fg-muted leading-relaxed">{l.cost}</div>
              </div>
              <div>
                <div className={cn('text-[10px] font-mono mb-0.5 tracking-widest uppercase', l.color)}>מה היא מחליפה</div>
  ...
  return (
    <div className="aspect-[16/9] relative rounded-xl overflow-hidden">
      <svg viewBox="0 0 100 56" className="w-full h-full">
        ...
        <text x="10" y="9" textAnchor="middle" className="fill-status-danger font-mono font-bold" fontSize="2.6" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.85" strokeLinejoin="round">
          שטח אויב
        </text>
        ...
        {activeLayers.has('physical') && (
          <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <text x="37.5" y="9" textAnchor="middle" className="fill-status-warn font-mono font-bold" fontSize="2.6" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.85" strokeLinejoin="round">
              אזור חיץ מפורז
            </text>
          </motion.g>
        )}
        ...
        <text x="77" y="9" textAnchor="middle" className="fill-fg-dim font-mono font-bold" fontSize="2.6" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.85" strokeLinejoin="round">
          שטחנו
        </text>
        ...
        {activeLayers.has('fence') && (
          <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <text x="55" y="50" textAnchor="middle" className="fill-accent font-mono font-bold" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
              גדר חכמה
            </text>
          </motion.g>
        )}
        ...
        {activeLayers.has('sensors') && (
          <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <text x="65" y="50" textAnchor="middle" className="fill-accent-cool font-mono font-bold" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
              חיישנים סייסמיים
            </text>
          </motion.g>
        )}
        ...
        {activeLayers.has('radar') && (
          <motion.g initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <text x="85" y="44" textAnchor="middle" className="fill-accent-hot font-mono font-bold" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
              רדאר
            </text>
            <text x="40" y="14" textAnchor="middle" className="fill-accent-hot font-mono" fontSize="2.2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.75" strokeLinejoin="round">
              ↤ טווח גילוי 25 ק"מ
            </text>
          </motion.g>
        )}
