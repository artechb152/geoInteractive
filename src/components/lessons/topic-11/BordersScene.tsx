...
export function BordersScene() {
  ...
  return (
    <section id="scene-borders" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="surface-elevated p-5 mb-6 border-r-4 border-r-accent-cool">
        <div className="flex gap-3 items-start">
          ...
          <div className="text-sm leading-relaxed">
            <strong className="text-fg">החלוקה הבסיסית:</strong>{' '}
          ...
          <div className="grid lg:grid-cols-2 gap-4 mt-5">
            ...
            <div className="space-y-3">
              <div className="surface p-3 rounded-lg bg-status-ok/5 border-status-ok/30">
                <div className="text-[10px] font-mono text-status-ok mb-1 tracking-widest uppercase">חוזק</div>
              ...
              <div className="surface p-3 rounded-lg bg-status-warn/5 border-status-warn/30">
                <div className="text-[10px] font-mono text-status-warn mb-1 tracking-widest uppercase">חולשה</div>
      ...
      <div className="surface-elevated p-6 rounded-2xl border-r-4 border-r-status-warn">
  ...
  return (
    <div className="aspect-[16/9] relative rounded-xl overflow-hidden">
      <svg viewBox="0 0 100 56" className="w-full h-full">
        ...
        <text x="25" y="52" textAnchor="middle" className="fill-status-danger font-mono font-bold" fontSize="2.6" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.85" strokeLinejoin="round">מדינה א</text>
        <text x="75" y="52" textAnchor="middle" className="fill-accent-cool font-mono font-bold" fontSize="2.6" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.85" strokeLinejoin="round">מדינה ב</text>
        ...
        {border.id === 'desert' && (
          <g>
            ...
            <text x="50" y="22" textAnchor="middle" className="fill-terrain-sand font-mono" fontSize="2.2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.75" strokeLinejoin="round">
              ~50 ק"מ ריקים
            </text>
          </g>
        )}
        ...
        {border.id === 'latitude' && (
          <g>
            ...
            <text x="50" y="46" textAnchor="middle" className="fill-status-warn font-mono" fontSize="2.2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.75" strokeLinejoin="round">
        ...
        {border.id === 'political' && (
          <g>
            ...
            <g transform="translate(50 24)">
              ...
              <text x="0" y="0" textAnchor="middle" className="fill-status-danger font-mono font-bold" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
                הסכם
              </text>
              <text x="0" y="2.5" textAnchor="middle" className="fill-status-danger font-mono" fontSize="1.4">
                1916
              </text>
            </g>
            ...
            <text x="50" y="50" textAnchor="middle" className="fill-status-danger font-mono" fontSize="2.2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.75" strokeLinejoin="round">
...
function StatBar({ label, value, color }: { label: string; value: number; color: string }) {
  return (
    <div className="surface p-2.5 rounded-lg">
      <div className="text-[10px] font-mono text-fg-dim mb-1 tracking-widest uppercase">{label}</div>
