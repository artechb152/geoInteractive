  ...
  return (
    <section id="scene-sensors" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="surface-elevated p-5 rounded-2xl mb-12">
        <div className="text-[10px] font-mono text-fg-dim mb-4 tracking-widest uppercase flex items-center justify-between flex-wrap gap-2">
      ...
      <div className="grid lg:grid-cols-[1.3fr_1fr] gap-6 items-stretch mb-12">
        ...
        <div className="space-y-3">
          ...
          <div className="surface p-4 rounded-xl border-r-4 border-r-status-danger bg-status-danger/5">
            <div className="text-[10px] font-mono text-status-danger mb-1 tracking-widest uppercase">סיכון מבצעי</div>
  ...
  return (
    <div className="aspect-[16/9] relative rounded-xl overflow-hidden">
      <svg viewBox="0 0 100 56" className="w-full h-full">
        ...
        {/* Time indicator */}
        <text x="6" y="9" className="fill-bg font-mono font-bold" fontSize="4" paintOrder="stroke" stroke="rgba(0,0,0,0.4)" strokeWidth="0.8" strokeLinejoin="round">
        ...
        {crossover && (
          <g>
            ...
            <text x="50" y="20" textAnchor="middle" className="fill-status-danger font-mono" fontSize="2.8" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.9" strokeLinejoin="round">
