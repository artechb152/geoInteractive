...
return (
 ...
 <text x="2" y={y - 0.6} className="fill-fg-dim font-display font-bold" fontSize="2"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
...
strokeLinejoin="round"
 ...
 <text x="50" y="98.5" textAnchor="middle" className="fill-fg-dim font-display font-bold" fontSize="2"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
...
y={y - 4}
textAnchor="middle"
className="fill-fg font-display font-bold font-bold"
fontSize="1.8"
paintOrder="stroke"
stroke="#ffffff"
strokeWidth="0.7"
