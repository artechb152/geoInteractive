...
strokeWidth={2.5}
 ...
 <div className="text-sm font-display font-semibold text-fg-muted mb-1 tracking-wider">טמפ' מורגשת</div>
 ...
 <div className="surface p-3 rounded-lg">
 <div className="text-sm font-display font-semibold text-fg-muted mb-1 tracking-wider">מים לחייל / שעה</div>
 <div className="font-display font-bold text-2xl tabular-nums text-accent">
