  ...
  return (
    <section id="scene-topography" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <SceneHeader
        ...
        title={
          <>
            איך <span className="gradient-text">דף שטוח</span> מתאר הר תלת־ממדי?
          </>
        }
...
function View3D() {
  return (
    <svg viewBox="0 0 100 75" className="w-full h-full">
      ...
      {/* Label */}
      <text x="55" y="22" textAnchor="middle" className="fill-fg text-[3px] font-mono opacity-70">פסגה · 412 מ׳</text>
    </svg>
  );
}
...
function ViewTopo() {
  return (
    <svg viewBox="0 0 100 75" className="w-full h-full">
      ...
      {/* Height labels */}
      <text x="48" y="36" textAnchor="middle" className="fill-accent text-[2.5px] font-mono">412</text>
      <text x="48" y="40" textAnchor="middle" className="fill-fg-muted text-[2px] font-mono">מ׳</text>
      <text x="13" y="60" className="fill-fg-muted text-[2.2px] font-mono">300</text>
      <text x="79" y="55" className="fill-fg-muted text-[2.2px] font-mono">350</text>
      ...
      <text x="22" y="63" className="fill-fg-muted text-[2px] font-mono">מבנה</text>

      {/* Coordinate corner */}
      <text x="2" y="73" className="fill-fg-dim text-[2px] font-mono">N31°45'</text>
      <text x="84" y="73" className="fill-fg-dim text-[2px] font-mono">E35°12'</text>
    </svg>
  );
}