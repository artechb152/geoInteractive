  ...
  return (
    <section id="scene-coordinates" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <SceneHeader
        ...
        title={
          <>
            כל מקום על הכדור — יש לו <span className="gradient-text">כתובת</span>
          </>
        }
          ...
          >
            <div className="flex items-baseline justify-between mb-4">
              <div>
                ...
                <div className="text-[10px] font-mono text-fg-dim mt-1 tracking-widest uppercase font-bold">
                  {s.scope}
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div className="text-[10px] font-mono text-status-ok mb-1.5 tracking-widest uppercase font-bold">יתרונות</div>
              ...
              <div>
                <div className="text-[10px] font-mono text-status-warn mb-1.5 tracking-widest uppercase font-bold">מגבלות</div>
                <ul className="space-y-1.5 text-xs">
                  {s.cons.map((c) => (
  ...
  return (
    ...
    >
      <div className="flex items-end justify-between gap-4 flex-wrap mb-4">
        <div>
          <div className="text-[10px] font-mono text-fg-dim mb-1 tracking-widest uppercase font-bold">
  ...
  return (
    <svg viewBox="0 0 100 56" className="w-full h-full" preserveAspectRatio="none">
      ...
      <g>
        ...
        <text x="50" y="44" textAnchor="middle" className="fill-accent-cool/80 text-[2.8px] font-mono font-bold">מטרה מבוקשת</text>
      </g>
      ...
      <motion.g animate={{ x: offsetX, y: -offsetY }} transition={{ type: 'spring', stiffness: 50 }}>
        ...
        <text x="50" y="26" textAnchor="middle" className="fill-accent-hot text-[2.8px] font-mono font-bold tracking-tighter">מיקום פגיעה בפועל</text>
      </motion.g>
...
function CoordinateAnatomy() {
  return (
    <motion.div
      ...
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
      className="surface-elevated p-8 border-r-4 border-r-accent rounded-xl flex flex-col md:flex-row gap-6 items-center"
    >
      <div className="p-4 bg-accent/10 rounded-full shrink-0">
        <Icon name="crosshair" size={32} className="text-accent" />
      </div>
      <div>
        <div className="text-[10px] font-mono text-accent mb-1 tracking-widest uppercase font-bold">
