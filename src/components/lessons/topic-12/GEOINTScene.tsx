...
className={cn('surface-elevated p-5 rounded-2xl border-r-4', l.border.replace('border-', 'border-r-'), l.bg)}
 ...
 <div>
 <div className="text-sm font-display font-semibold text-fg-muted mb-0.5 tracking-wider">מקור</div>
 <p className="text-fg leading-relaxed">{l.source}</p>
 </div>
 <div>
 <div className="text-sm font-display font-semibold text-status-ok mb-0.5 tracking-wider">חוזק</div>
 <p
...
dangerouslySetInnerHTML={{ __html: l.strength }}
 ...
 <div>
 <div className="text-sm font-display font-semibold text-status-warn mb-0.5 tracking-wider">מגבלה</div>
...
return (
 ...
 <text x="50" y="20" textAnchor="middle" className="fill-accent font-display font-bold font-bold" fontSize="2.2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.75" strokeLinejoin="round">
 אזור מטרה
 </text>
 ...
 <text x="62" y="26" textAnchor="middle" className="fill-accent font-display font-bold font-bold" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
 [IMINT] טנק T-90
 </text>
 </motion.g>
 )}
 ...
 <text x="68" y="34" textAnchor="middle" className="fill-accent-cool font-display font-bold font-bold" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
 [SIGINT] שידור 144MHz
 </text>
 </motion.g>
 )}
 ...
 <text x="44" y="40" textAnchor="middle" className="fill-accent-hot font-display font-bold font-bold" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
 ...
 <text x="68" y="46" textAnchor="middle" className="fill-status-warn font-display font-bold font-bold" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
 [OSINT] Twitter:"ראיתי טנקים בכפר"
 </text>
 <text x="68" y="49" textAnchor="middle" className="fill-status-warn font-display font-bold" fontSize="1.6" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.6" strokeLinejoin="round">
tweet · 14:32
 </text>
 </motion.g>
 )}
