...
const STEPS: Step[] = [
  {
    ...
    popupBody:
      'בעבר מפה הייתה ציור — קווים וצבעים על נייר, או סריקה שלהם למחשב. גם בגרסה הדיגיטלית המפה עדיין <strong>"טיפשה"</strong>: היא לא יודעת שהקו האדום הוא כביש או שהמשולש הוא הר, היא רק מציגה צורות. <strong>הבעיה:</strong> המידע לא מחובר למשמעות שלו — כדי לשנות משהו צריך לצייר מחדש, לא לעדכן נתון.',
  },
  {
    id: 'layers',
...
title = {
  <>
    GIS הופך מפה רגילה ל<span className="text-accent-hover">מערכת שמקבלת החלטות</span>
        ...
        intro="מפה רגילה היא ציור: היא מציגה איפה עובר הכביש, אבל לא יודעת שזה כביש. GIS הופך אותה למערכת שמבינה את עצמה — מחשבת איומים, מציעה מסלולים, ומזהה נקודות תורפה. בארבעה שלבים נעבור מתצלום פשוט להחלטה מבצעית."
      />
