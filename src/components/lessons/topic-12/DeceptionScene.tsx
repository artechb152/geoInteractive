...
export function DeceptionScene() {
  ...
  return (
    <section id="scene-deception" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="grid sm:grid-cols-3 gap-3 mb-4">
            <div className="surface p-3 rounded-lg">
              <div className="text-[10px] font-mono text-accent mb-1 tracking-widest uppercase flex items-center gap-1.5">
                <Icon name="eye" size={11} /> אופטי
              </div>
              <p className="text-xs text-fg leading-relaxed">{meta.optical}</p>
            </div>
            <div className="surface p-3 rounded-lg">
              <div className="text-[10px] font-mono text-accent-hot mb-1 tracking-widest uppercase flex items-center gap-1.5">
                <Icon name="bolt" size={11} /> SAR
              </div>
              <p className="text-xs text-fg leading-relaxed">{meta.sar}</p>
            </div>
            <div className="surface p-3 rounded-lg">
              <div className="text-[10px] font-mono text-status-warn mb-1 tracking-widest uppercase flex items-center gap-1.5">
          ...
          <div className={cn(
            ...
            <div className={cn(
              'text-[10px] font-mono mb-1 tracking-widest uppercase flex items-center gap-1.5',
      ...
      {/* OSINT explanation */}
      <div className="surface-elevated p-6 rounded-2xl border-r-4 border-r-status-warn mb-6">
        ...
        {[
          ...
          >
            ...
            <div className="surface p-2.5 rounded-lg bg-bg-accent/30">
              <div className="text-[10px] font-mono text-status-ok mb-0.5 tracking-widest uppercase flex items-center gap-1.5">
      ...
      <svg viewBox="0 0 100 56" className="w-full h-full">
        ...
        {mode === 'fusion' && (
          <>
            ...
            <text x="25" y="6" textAnchor="middle" className="fill-accent font-mono font-bold" fontSize="2.4" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.8" strokeLinejoin="round">
              אופטי
            </text>
            <text x="75" y="6" textAnchor="middle" className="fill-accent-hot font-mono font-bold" fontSize="2.4" paintOrder="stroke" stroke="#0c1218" strokeWidth="0.8" strokeLinejoin="round">
              SAR
            </text>
          </>
        )}
          ...
          <>
            ...
            {(mode === 'optical' || mode === 'fusion') && (
              <g transform="translate(35 35)">
                ...
                <text x="0" y="5" textAnchor="middle" className="fill-accent font-mono font-bold" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
                  ✓ טנק T-72
                </text>
              </g>
            )}
            {(mode === 'sar' || mode === 'fusion') && (
              <g transform={`translate(${mode === 'fusion' ? 75 : 65} 35)`}>
                ...
                <text x="0" y="5" textAnchor="middle" className="fill-accent-hot font-mono font-bold" fontSize="2" paintOrder="stroke" stroke="#0c1218" strokeWidth="0.7" strokeLinejoin="round">
                  ✓ החזר מתכת
                </text>
              </g>
            )}
          ...
          <>
            ...
            {(mode === 'sar' || mode === 'fusion') && (
              <g transform={`translate(${mode === 'fusion' ? 75 : 65} 35)`}>
                ...
                <text x="0" y="-5" textAnchor="middle" className="fill-status-warn font-mono font-bold" fontSize="2" paintOrder="stroke" stroke="#0c1218" strokeWidth="0.7" strokeLinejoin="round">
                  ✗ אין מתכת!
                </text>
                <text x="0" y="6" textAnchor="middle" className="fill-status-warn font-mono" fontSize="1.6" paintOrder="stroke" stroke="#0c1218" strokeWidth="0.6" strokeLinejoin="round">
                  ← הונאה!
                </text>
              </g>
            )}
          ...
          <>
            {(mode === 'optical' || mode === 'fusion') && (
              <g transform="translate(35 35)">
                ...
                <text x="0" y="5" textAnchor="middle" className="fill-fg-muted font-mono" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">
                  צמחייה/הסוואה
                </text>
              </g>
            )}
            {(mode === 'sar' || mode === 'fusion') && (
              <g transform={`translate(${mode === 'fusion' ? 75 : 65} 35)`}>
                ...
                <text x="0" y="-6" textAnchor="middle" className="fill-accent-hot font-mono font-bold" fontSize="2" paintOrder="stroke" stroke="#0c1218" strokeWidth="0.7" strokeLinejoin="round">
                  ✓ SAR חודר!
                </text>
              </g>
            )}
        ...
        {/* Mode label */}
        {mode !== 'fusion' && (
          <text x="50" y="6" textAnchor="middle" className={cn('font-mono font-bold', mode === 'optical' ? 'fill-accent' : 'fill-accent-hot')} fontSize="3" paintOrder="stroke" stroke={mode === 'optical' ? '#ffffff' : '#0c1218'} strokeWidth="1" strokeLinejoin="round">
