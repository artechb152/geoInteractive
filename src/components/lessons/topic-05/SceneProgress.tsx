...
const SCENES = [
  ...
  { id: 'trafficability', label: '05.1 · עבירות' },
  { id: 'engineering',    label: '05.2 · הנדסה' },
  { id: 'cover',          label: '05.3 · מחסה והסתרה' },
  { id: 'vegetation',     label: '05.4 · תכסית וצומח' },
