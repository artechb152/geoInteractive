        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-3 mb-4">
            <div className="surface p-4 rounded-xl">
              <div className="text-[10px] font-mono text-fg-dim mb-1.5 tracking-widest uppercase flex items-center gap-1.5">
          ...
          <div className="grid sm:grid-cols-2 gap-3 mb-4">
            <div className="surface p-4 rounded-xl bg-accent-cool/5 border-accent-cool/30">
              <div className="text-[10px] font-mono text-accent-cool mb-1.5 tracking-widest uppercase">לתוקף</div>
            ...
            <div className="surface p-4 rounded-xl bg-accent-hot/5 border-accent-hot/30">
              <div className="text-[10px] font-mono text-accent-hot mb-1.5 tracking-widest uppercase">למגן</div>
          ...
          <div className="surface p-3 rounded-lg bg-bg-accent/30 border border-border">
            <div className="text-[10px] font-mono text-fg-dim mb-1 tracking-widest uppercase">דוגמה היסטורית</div>
  ...
  return (
    <g>
      ...
      <g>
        ...
        <text x="93" y="24" textAnchor="middle" className="fill-accent-hot font-mono font-bold" fontSize="2.4" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.8" strokeLinejoin="round">
          צלף · Enfilade
        </text>
      </g>

      {/* Stats label */}
      <text x="50" y="53" textAnchor="middle" className="fill-fg-dim font-mono" fontSize="2.4" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.8" strokeLinejoin="round">
    ...
    <g>
      ...
      {[
        ...
        <g key={i}>
          ...
          <text x={t.x} y={t.y - 2.2} textAnchor="middle" className="fill-accent-hot font-mono" fontSize="1.8" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.6" strokeLinejoin="round">
            {t.label}
          </text>
        </g>
      ))}
