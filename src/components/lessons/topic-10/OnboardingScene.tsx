  ...
  return (
    <section id="scene-onboarding" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <ReadyCallout title="עכשיו אתה מוכן">
        <p>הבנת שעיר זה לא "שטח אופקי" — זה <strong>קוביית רוביק</strong>. בשלוש הסצנות הבאות נצלול:
            <strong className="text-fg"> איך גריד שונה מקסבה טקטית, איך עובד הקרב התלת-ממדי, ולמה אזרחים הם הפקטור הכי קשה</strong>.</p>
      </ReadyCallout>
    </section>
  );
}
