  ...
  return (
    <section id="scene-civilian" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div>
              <div className="text-[10px] font-mono text-fg-dim mb-1.5 tracking-widest uppercase">מהות האתר</div>
              <p className="text-sm text-fg leading-relaxed">{meta.desc}</p>
            </div>
            <div>
              <div className="text-[10px] font-mono text-accent-cool mb-1.5 tracking-widest uppercase flex items-center gap-1.5">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="surface-elevated p-5 rounded-2xl border-r-4 border-r-status-ok">
          ...
          <div className="surface p-3 rounded-lg bg-bg-accent/30 border border-border">
            <div className="text-[10px] font-mono text-status-ok mb-1 tracking-widest uppercase">דרישות תיאום</div>
        ...
        <div className="surface-elevated p-5 rounded-2xl border-r-4 border-r-accent">
          ...
          <div className="surface p-3 rounded-lg bg-bg-accent/30 border border-border">
            <div className="text-[10px] font-mono text-accent mb-1 tracking-widest uppercase">דוגמה ל-ROE</div>
            <p className="text-xs text-fg-muted leading-relaxed">
              "אש רק בתגובה לאש מזוהה" / "תקיפה רק אחרי אזהרה ופינוי" / "הימנעות מירי לכיוון אתר רגיש מסומן". כל סיטואציה אחרת.
            </p>
          </div>
        </div>
      </div>
          ...
          return (
            <g key={s.id} onClick={() => onSelect(s.type)} style={{ cursor: 'pointer' }}>
              ...
              <text
                ...
                y={s.position.y - 3.5}
                textAnchor="middle"
                className={cn('font-mono font-bold', m.color)}
                fontSize="2"
                paintOrder="stroke"
                stroke="#ffffff"
                strokeWidth="0.7"
