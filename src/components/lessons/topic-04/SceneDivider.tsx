...
export function SceneDivider({ next }: { next?: string }) {
  return (
    ...
    >
      ...
      {next && (
        <div className="mt-4 px-4 py-1.5 rounded-full border border-border-subtle bg-bg-card/50 backdrop-blur text-[10px] font-mono text-fg-dim tracking-widest uppercase">
          {next}
        </div>
      )}
    </motion.div>
