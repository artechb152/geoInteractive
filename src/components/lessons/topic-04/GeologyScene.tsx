...
className="surface-elevated p-5 sm:p-6 grid md:grid-cols-2 gap-6"
 ...
 <p className="text-fg-muted text-sm">
 הנוף לא קיים סתם ככה. הוא נוצר מ-2 סוגי כוחות: כוחות שדוחפים מבפנים כדור הארץ, מתחת לפני השטח (יוצרים הרים), וכוחות
 שמבלים מבחוץ, על פני השטח עצמו (חורצים גיאיות).
 </p>
 </div>
