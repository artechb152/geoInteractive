...
const TYPES: TypeData[] = [
  {
    ...
    fullDef: 'בדרך כלל זה גובה (פסגה, שלוחה גבוהה), אבל לא חייב. זה כל מקום שמאפשר לראות, לירות ולחסום את האויב באזור גדול מסביב. השליטה מגיעה מהיכולת לכסות את התנועות והאספקה של היריב.',
    example: 'רמת הגולן — מי ששולט בה רואה ויורה לכל גליל. לכן ב-1967 ישראל פעלה כל כך נחרצות לכבוש אותה, ולכן ב-1973 הסורים פעלו כל כך נחרצות לכבוש אותה חזרה.',
  ...
  },
  {
    ...
    fullDef: 'לא חייב להיות גבוה או "שולט". זה כל אתר שהשליטה בו קריטית להצלחת המשימה. צומת דרכים בעמק שדרכו עוברת כל האספקה — זה שטח חיוני, גם אם הוא נמוך.',
    example: 'גשר על הירדן: לא גבוה, לא מרשים. אבל אם אויב חוסם אותו — אוגדה שלמה לא יכולה לעבור לחזית. בקרבות 67 ו-73 היו קרבות עזים על גשרים בודדים.',
  ...
  },
  {
    ...
    fullDef: 'אזור שמסתתר מקווי הראייה והאש של האויב — בגלל הר שמסתיר אותו, מצוק, או יער עבות. זה "אזור בטוח" לתנועה ולהתחפרות. נוצר בגלל הזווית של השטח, לא בגלל מבנה צבאי.',
    example: 'בשנת 2014 בעזה, חמאס בנה רשת מנהרות בדיוק בשטחים מתים — מקומות שצה"ל לא ראה מהאוויר ולא יכל לירות אליהם בכינון ישיר.',
  ...
  return (
    <section id="scene-tactical" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <SceneHeader
        ...
        title={
          <>
            לא כל שטח <span className="gradient-text">שווה אותו דבר</span>
          </>
        }
        intro="מפקדים מסווגים שטח לפי הערך הצבאי שלו. 3 סוגי שטח שכל מי שמתכנן מבצע חייב לזהות במפה — לפני שהוא בכלל יוצא לשטח."
      />
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <div>
              <div className="text-[10px] font-mono text-fg-dim mb-2 tracking-widest uppercase">הגדרה מלאה</div>
              <p className="text-sm leading-relaxed text-fg">{meta.fullDef}</p>
            </div>
            <div>
              <div className="text-[10px] font-mono text-fg-dim mb-2 tracking-widest uppercase">מי משתמש בזה</div>
      ...
      >
        ...
        <div>
          <div className="text-[10px] font-mono text-accent mb-1 tracking-widest uppercase">המסקנה</div>
          <p className="text-fg leading-relaxed text-pretty">
            המפה היא לא רק קווים וצבעים — היא <strong className="text-fg">סיפור על מי ינצח כאן</strong>.
            ברגע שאתה יודע לזהות שטח שולט, שטח חיוני ושטח מת — אתה לא קורא מפה. אתה רואה תוכנית קרב.
          </p>
        </div>
      </motion.div>
    </section>
      ...
      <div className="aspect-[16/10] relative">
        <svg viewBox="0 0 160 100" className="w-full h-full" preserveAspectRatio="none">
          ...
          <motion.g initial={false} animate={{ opacity: showKey ? 1 : 0.15 }} transition={{ duration: 0.4 }}>
            ...
            <text x="80" y="92" textAnchor="middle" className="fill-accent-hot text-[2.6px] font-mono font-bold">שטח חיוני</text>
            <text x="80" y="95.5" textAnchor="middle" className="fill-accent-hot text-[1.9px] font-mono">צומת דרכים יחיד</text>
          </motion.g>
          ...
          <motion.g initial={false} animate={{ opacity: showCommand ? 1 : 0.15 }} transition={{ duration: 0.4 }}>
            ...
            <text x="60" y="14" textAnchor="middle" className="fill-accent text-[2.6px] font-mono font-bold">שטח שולט</text>
            <text x="60" y="17.5" textAnchor="middle" className="fill-accent text-[1.9px] font-mono">פסגה · רואה הכל</text>
          ...
          <motion.g initial={false} animate={{ opacity: showDead ? 1 : 0.15 }} transition={{ duration: 0.4 }}>
            ...
            <text x="130" y="73" textAnchor="middle" className="fill-status-ok text-[2.6px] font-mono font-bold">שטח מת</text>
            <text x="130" y="77" textAnchor="middle" className="fill-status-ok text-[1.9px] font-mono">סמוי מהפסגה</text>
