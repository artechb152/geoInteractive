...
/**
 * WebP frame-sequence player for the flat/mountain/valley/analyzed
 * accordion — same technology as topic-01,02,04/SceneOnboardingFramePlayer.tsx
 * (see those files for the full rationale). Frames are drawn onto a single
...
const ASSET_BASE = '/assets/scene-onboarding/topic-03';

const STEPS_ORDER: View[] = ['flat', 'mountain', 'valley', 'analyzed'];
const STEP_INDEX: Record<View, number> = { flat: 0, mountain: 1, valley: 2, analyzed: 3 };
...
const STATE_IMAGE_PATH: Record<View, string> = {
  ...
  valley: `${ASSET_BASE}/states/state-3-valley.webp`,
  analyzed: `${ASSET_BASE}/states/state-4-analyzed.webp`,
};
...
// Same pacing as topic-01/02/04: a direct (single-segment) hop targets
...
// Same module-level-flag pattern as topic-01/02/04's players — read directly
// inside the rAF loop rather than prop-drilled React state.
