...
const CHECKPOINTS: Checkpoint[] = [
 ...
 { id: '3', label: 'נקודה 3: אוכף הרכס', feature: 'עולים אל קו הרכס ומכוונים אל האוכף — המעבר הנמוך בין שתי הפסגות. הקרקע עולה משני הצדדים ויורדת במעבר, סימן ודאי שאתם על הציר.', icon: 'mountain' },
