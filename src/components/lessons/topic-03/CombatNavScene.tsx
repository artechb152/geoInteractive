...
return (
 ...
 <text x="50" y="58" textAnchor="middle" className="fill-terrain-ridge text-[3px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
      >תחתית רכס · המעקה</text>
 ...
 <text x="50" y="38" textAnchor="middle" className="fill-status-danger text-[2.5px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
      >קו ישר · חשוף לאויב</text>
 ...
 <text x="10" y="69" textAnchor="middle" className="fill-accent-cool text-[2.5px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
 ...
 <text x="90" y="16" textAnchor="middle" className="fill-accent-hot text-[2.5px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
 ...
 <text x={x} y={y - 2} textAnchor="middle" className="fill-status-danger text-[2px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
...
return <circle key={i} cx={x} cy={y} r="0.4" className="fill-fg/30" />;
 ...
 {/* Azimuth label */}
 <text x="50" y="36" textAnchor="middle" className="fill-accent text-[3px] font-display font-bold font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
 ...
 <text x="15" y="68" textAnchor="middle" className="fill-accent-cool text-[2.5px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
 ...
 <text x="85" y="14" textAnchor="middle" className="fill-accent-hot text-[2.5px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
...
return (
 ...
 <text x="25" y="12" textAnchor="middle" className="fill-fg-muted text-[3.5px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
      >שטח פתוח</text>
 <text x="25" y="68" textAnchor="middle" className="fill-status-warn text-[2.5px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
      >חשוף · קצב איטי + דילוגים</text>
 ...
 <text x="75" y="12" textAnchor="middle" className="fill-fg-muted text-[3.5px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
      >יער עבות</text>
 <text x="75" y="68" textAnchor="middle" className="fill-status-ok text-[2.5px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
      >מוסתר · קצב מהיר ורציף</text>
 ...
 <text x="18" y="42" textAnchor="middle" className="fill-accent-cool text-[2px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
 ...
 <text x="67" y="34" textAnchor="middle" className="fill-accent-cool text-[2px] font-display font-bold"
        paintOrder="stroke"
        stroke="#ffffff"
        strokeWidth="0.9"
        strokeLinejoin="round"
