  ...
  return (
    <section id="scene-onboarding" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <ReadyCallout title="עכשיו אתה מוכן">
        <p>הבנת שלוגיסטיקה זה לא "תמיכה" — זה הקרב המקביל. בשלוש הסצנות הבאות נצלול:
            <strong className="text-fg"> איך עובדים MSR ו-ASR בפועל, איך הבטן הלוגיסטית גדלה ונחשפת, ולמה נמלי מים עמוקים שווים אוגדה שלמה</strong>.</p>
      </ReadyCallout>
    </section>
  );
}
