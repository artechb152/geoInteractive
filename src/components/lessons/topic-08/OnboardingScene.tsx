...
title = {
  <>
    <span className="text-accent-hover">מי ששולט באספקה</span> שולט בקצב המלחמה
  </>
}
      ...
      <div className="grid md:grid-cols-[2fr_3fr] gap-6 items-start">
        ...
        <div className="surface-elevated bg-bg-accent/30 relative overflow-hidden aspect-video min-h-[320px]">
