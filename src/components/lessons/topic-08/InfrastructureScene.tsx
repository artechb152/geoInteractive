...
className="surface-elevated p-5 rounded-2xl"
 ...
 <div className="mb-3">
 <div className="text-sm font-display font-semibold text-fg-muted mb-1 tracking-wider">חלק מקיבולת התשתית</div>
 ...
 <div>
 <dt className="text-sm font-display font-semibold text-fg-muted mb-0.5 tracking-wider">תפקיד</dt>
 <dd className="text-fg leading-relaxed">{meta.role}</dd>
 </div>
 <div>
 <dt className="text-sm font-display font-semibold text-fg-muted mb-0.5 tracking-wider">פגיעות</dt>
 <dd className="text-fg-muted leading-relaxed">{meta.vulnerability}</dd>
 </div>
 <div>
 <dt className="text-sm font-display font-semibold text-fg-muted mb-0.5 tracking-wider">ערך אסטרטגי</dt>
...
className="surface p-4 rounded-xl bg-status-danger/5"
 >
 <div className="text-sm font-display font-semibold text-status-danger mb-1 tracking-wider">השפעה אסטרטגית</div>
...
className=""
 ...
 <div className="text-sm font-display font-semibold text-terrain-sky mb-1 tracking-wider">שליטה / נטרול</div>
 <p className="text-xs text-fg-muted leading-relaxed">
