        ...
        <div className="flex gap-4 items-start">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-fg-muted leading-relaxed text-pretty">
              <strong className="text-fg">ציר ה-MSR</strong> מתוכנן להעביר כמויות. כשהוא פתוח, הציוד זורם לחזית בכמויות אדירות ובמהירות. לעומת זאת, <strong className="text-fg">ציר ה-ASR</strong> מתוכנן כדי שלא נמות. הוא פחות נוח, איטי יותר ומעביר פחות ציוד, אבל הוא שם כשהציר הראשי נחסם.
              <br /><br />
