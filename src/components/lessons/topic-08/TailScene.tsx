  ...
  return (
    <section id="scene-tail" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid lg:grid-cols-[1fr_1.4fr] gap-6 items-stretch mb-12">
        ...
        {/* Stats panel */}
        <div className="surface-elevated p-5 rounded-2xl">
          <div className="text-[10px] font-mono text-fg-dim mb-4 tracking-widest uppercase">
            השפעה על הסד"כ
          </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-10">
        ...
        <div className="surface-elevated p-5 rounded-2xl border-r-4 border-r-accent-cool">
          <div className="flex items-center gap-2.5 mb-3">
  ...
  return (
    <div className="aspect-[16/9] relative rounded-xl overflow-hidden">
      <svg viewBox="0 0 100 56" className="w-full h-full">
        ...
        {securedEndX > baseX + 4 && (
          <text x={(baseX + securedEndX) / 2} y="22" textAnchor="middle" className="fill-status-ok font-mono font-bold" fontSize="2.4" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.8" strokeLinejoin="round">
            אזור מאובטח
          </text>
        )}
        ...
        {securedEndX < frontX - 2 && (
          <>
            ...
            <text x={(securedEndX + frontX) / 2} y="22" textAnchor="middle" className="fill-status-danger font-mono font-bold" fontSize="2.4" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.8" strokeLinejoin="round">
              אזור פגיעות
            </text>
          </>
        )}
        ...
        <g>
          ...
          <text x={baseX} y="42" textAnchor="middle" className="fill-fg-dim font-mono" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">0 ק"מ</text>
        </g>
        ...
        <g>
          ...
          <text x={frontX} y="42" textAnchor="middle" className="fill-fg-dim font-mono" fontSize="2" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.7" strokeLinejoin="round">{depth} ק"מ</text>
        </g>
          ...
          <>
            {[
              ...
              <g key={i}>
                ...
                <text x={p.x} y={p.y + 3.5} textAnchor="middle" className="fill-status-danger font-mono" fontSize="1.8" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.6" strokeLinejoin="round">
                  צייד
                </text>
              </g>
            ))}
        ...
        {/* Truck count label */}
        <text x="50" y="9" textAnchor="middle" className="fill-fg-muted font-mono" fontSize="2.4" paintOrder="stroke" stroke="#ffffff" strokeWidth="0.8" strokeLinejoin="round">
