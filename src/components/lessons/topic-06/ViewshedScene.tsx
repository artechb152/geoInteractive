...
title = {
  <>
    <span className="gradient-text">במקום לבדוק נקודה־נקודה</span> — נותנים למפה לחשוף מה רואים
  </>
}
        intro="במקום שנמתח קו ראייה (LOS – Line of Sight) אחד בכל פעם, תוכנות מיפוי עושות את זה בשבילנו. הן מחשבות מיליוני קווי ראייה בשנייה, וצובעות את המפה: ירוק (שטח גלוי) ואדום (שטח מת שמוסתר מאיתנו). הזיזו את התצפיתן במפה ותראו איך הכל משתנה בלייב."
      />
