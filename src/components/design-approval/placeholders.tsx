...
export const LESSON_CARD_SLOTS: ReadonlyArray<{
  ...
  { lesson: 3, assetId: 'LESSON-03-CARD', src: '/assets/isometric/lesson-03-landforms.png', alt: 'איור פייפרקאט: שלוש צורות נוף — גבעה מעוגלת, רכס ואוכף' },
  { lesson: 4, assetId: 'LESSON-04-CARD', src: '/assets/isometric/lesson-04-mobility.png', alt: 'איור פייפרקאט: משטח שטח עם נתיב עביר, כתם צמחייה ורכב זעיר' },
  { lesson: 5, assetId: 'LESSON-05-CARD', src: '/assets/isometric/lesson-05-los.png', alt: 'איור פייפרקאט: גבעה עם עמדת תצפית ומניפת שדה ראייה' },
  { lesson: 6, assetId: 'LESSON-06-CARD', src: '/assets/isometric/lesson-06-navigation.png', alt: 'איור פייפרקאט: מצפן על קפל שטח עם נתיב נקודות אל דגלון כתום' },
